...
class Bigbluebutton {
	...
	*/
		...
		$this->_securitySalt 		= isset($config['bbb_security_salt']) ? $config['bbb_security_salt'] : '';
		$this->_bbbServerBaseUrl 	= isset($config['bbb_base_server_url']) ? $config['bbb_base_server_url'] : '';
	}
